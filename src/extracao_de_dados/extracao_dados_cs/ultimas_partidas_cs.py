...
source = requests.get("https://bo3.gg/pt/teams/furia/matches")
...
ultimas_partidas = site.find_all("div", attrs={"class":"table-row table-row--finished data-advantage"})
...
lista_ultimas_partidas.to_json("src\\dados\\base_ultimas_cs.json", orient="records", indent=4, force_ascii=False, index=False) 
